  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 dark:bg-slate-900 dark:text-slate-100 transition-colors">
      ...
      <div className="flex min-h-[calc(100vh-56px)]">
        <aside className="hidden lg:flex flex-shrink-0 border-r border-slate-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 dark:border-slate-700 dark:bg-slate-800/80">
          <div className="flex h-full w-full flex-col">
            {sidebar ?? <ProjectsSidebar />}
          </div>
        </aside>
        <main className="flex min-h-[calc(100vh-56px)] flex-1 flex-col overflow-hidden">
          <Content />
        </main>
      </div>
    </div>
