...
const BrandLogo = () => {
  return (
    ...
    >
      <div className="rounded-md p-1 bg-gradient-to-br from-slate-800/40 to-slate-700/30 dark:from-slate-700/40 dark:to-slate-800/30 text-cyan-400">
        <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" aria-hidden="true" role="img">
      ...
      <div className="leading-tight">
        <div className="text-base font-semibold tracking-tight text-slate-900 dark:text-slate-50">EagleEye</div>
        <div className="text-xs text-slate-600 dark:text-slate-400">by Nagrik</div>
      </div>
    </Link>
  );
};
